...
import com.s21.devops.sample.hotelservice.Communication.ErrorResponse;
import com.s21.devops.sample.hotelservice.Communication.ErrorValidationResponse;
...
public class ExceptionController {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ErrorResponse hotelNotFoundsExceptionHandle(HotelNotFoundException exception){
        return new ErrorResponse(exception.getMessage());
    }
