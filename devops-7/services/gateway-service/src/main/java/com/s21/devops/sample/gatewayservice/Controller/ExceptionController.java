...
import com.s21.devops.sample.gatewayservice.Communication.ErrorResponse;
import com.s21.devops.sample.gatewayservice.Communication.ErrorValidationResponse;
...
public class ExceptionController {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ErrorResponse userAlreadyExistsExceptionHandle(UserAlreadyExistsException exception){
        return new ErrorResponse(exception.getMessage());
    }

    @ExceptionHandler(HotelAlreadyExistsException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ErrorResponse HotelAlreadyExistsExceptionHandle(HotelAlreadyExistsException exception){
        return new ErrorResponse(exception.getMessage());
    }
