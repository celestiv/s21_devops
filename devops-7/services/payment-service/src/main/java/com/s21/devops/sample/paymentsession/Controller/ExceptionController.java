...
import com.s21.devops.sample.paymentsession.Communication.ErrorResponse;
import com.s21.devops.sample.paymentsession.Communication.ErrorValidationResponse;
...
public class ExceptionController {
    ...
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ErrorResponse hotelNotFoundsExceptionHandle(PaymentNotFoundException exception){
        return new ErrorResponse(exception.getMessage());
    }
