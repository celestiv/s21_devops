...
public class JwtProvider {
    ...
    public String generateToken(UUID userUid) throws NoSuchAlgorithmException, InvalidKeySpecException {
    ...
    public UUID getUserUidFromToken(String token) throws NoSuchAlgorithmException, InvalidKeySpecException {
        byte[] encodedPrivateKey = Base64.decode(publicKey.getBytes());
        X509EncodedKeySpec spec = new X509EncodedKeySpec(encodedPrivateKey);
        KeyFactory kf = KeyFactory.getInstance("RSA");
