...
import com.s21.devops.sample.sessionservice.Communication.ErrorResponse;
import com.s21.devops.sample.sessionservice.Communication.ErrorValidationResponse;
...
public class ExceptionController {
    ...
    public ErrorResponse roleNotFoundExceptionHandle(RoleNotFoundException exception){
        return new ErrorResponse(exception.getMessage());
    }
